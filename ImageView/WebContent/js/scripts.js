...
;(function ( $, window, document, undefined ) {
    ...
    function Plugin( element, options ) {
		...
		this.$imagesControls = $('.imagesControls');
        this.$control = $('.control');
		this.$imagesControl = $('.imagesControl');
        this.$grid = $('.grid');
    ...
    Plugin.prototype = {
        ...
        bindListHandler: function(smallItems){
            ...
            smallItems.on('click', 'li a img', function(e){
...
//                alert(that.current);
		...
		showImagesControls:function(){
            this.$imagesControls.addClass('showImagesControls')
                          .removeClass('hideImagesControls');
        },
		...
		hideImagesControls: function(){
            this.$imagesControls.addClass('hideImagesControls')
                          .removeClass('showImagesControls');
        },
